/* 
    tree_and_buildings.dart generates a flat grid with trees and buildings in lidar csv format
*/
import 'dart:io';
import 'dart:math';
    ...
    for (int b = 0; b < count; b++) {
        ...
        for (int x = 0; x < w; x++) {
            for (int y = 0; y < h; y++) {
                ...
                y0 + y,
                roofZ + rnd(-0.15, 0.15),
                rnd(45, 60), // roof range is low intensity for classifier
                ));
            }
        }
...
void main() {
    generateFullCSV("flat_tree_and_building_example.csv");
}